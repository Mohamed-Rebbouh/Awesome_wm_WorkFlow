...
local globalKeys =
  ...
  { modkey }, "h",
    ...
    {description = "hide focused window", group = "client"}
  ),
  awful.key(
  { modkey }, "=",
    function ()
        awful.util.spawn_with_shell('cd ~/.config/rofi && ./rofi_wifi.sh')        
    end,
    {description = "wifi", group = "awesome"}
  ),
  awful.key(
    {modkey},
    'r',
  ...
  awful.key(
    ...
    {description = 'rofi run windows', group = 'awesome'}
  ),
  awful.key(
    {modkey, 'Shift'},
    'r',
  ...
  awful.key(
    ...
    'l',
    function()
      awful.util.spawn_with_shell('cd ~/.config/rofi && ./rofi_power.sh')
    end,
    {description = 'rofi log out menu ', group = 'awesome'}
  ),
  ...
  awful.key(
    ...
    {description = 'rofi time', group = 'launcher'}
  )
